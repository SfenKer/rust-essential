...
public class DiscordUtility {
    ...
    public static @NotNull Container container(
        @NotNull Collection<ContainerChildComponent> components
    ) {
    ...
    public static @NotNull MediaGallery mediaGallery(
        @NotNull MediaGalleryItem mediaGalleryItem,
        @NotNull MediaGalleryItem... mediaGalleryItems
    ) {
        return MediaGallery.of(mediaGalleryItem, mediaGalleryItems);
    }

    public static @NotNull MediaGalleryItem mediaGalleryItem(
        @NotNull String url
    ) {
